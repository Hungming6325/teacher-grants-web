...
export default function PanelCard({ children, className = "" }: Props) {
  return (
    <div
      className={`relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900/70 p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_20px_60px_rgba(0,0,0,0.35)] backdrop-blur-xl ${className}`}
    >
